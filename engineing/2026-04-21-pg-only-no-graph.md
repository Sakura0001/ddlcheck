...
- Removed non-PostgreSQL providers, schemas, grammar resources, tests, and JDBC/runtime jars for MySQL, MariaDB, SQLite, TiDB, and CockroachDB.
- Removed reducer, duplicate-detection, SchemaGraph, and JUNG graph dependencies.
- Restricted runtime provider registration to PostgreSQL.
