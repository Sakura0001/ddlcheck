...
create_table:
    ...
    # | CREATE TEMPORARY? TABLE if_not_exist? _new_table_name LIKE _table  # copy create table
    # | CREATE TEMPORARY? TABLE if_not_exist? _new_table_name AS? select # query create table
