...
public abstract class Query implements Loggable {
    ...
    public abstract <G extends GlobalState> boolean execute(G globalState, String... fills) throws Exception;
    ...
    public <G extends GlobalState> DBRadarResultSet executeAndGet(G globalState, String... fills) throws Exception {
        throw new AssertionError();
    }

    public <G extends GlobalState> boolean executeLogged(G globalState) throws Exception {
        logQueryString(globalState);
        return execute(globalState);
    }

    public <G extends GlobalState> DBRadarResultSet executeAndGetLogged(G globalState) throws Exception {
        logQueryString(globalState);
        return executeAndGet(globalState);
    }

    private <G extends GlobalState> void logQueryString(G globalState) {
