...
import dbradar.Randomly.StringGenerationStrategy;
...
public class MainOptions {
    ...
    @Parameter(names = "--print-progress-summary", description = "Whether to print an execution summary when exiting randgen.sqlancer", arity = 1)
    ...
    @Parameter(names = "--grammar-path", description = "The grammar path used to generate queries")
    private String grammarPath;

    @Parameter(names = "--generator-config-path", description = "The config path used to specify generators for data types")
    private String generatorConfigPath;

    @Parameter(names = "--max-production-recursion", description = "The config path used to specify generators for data types")
    private int maxProductionRecursion = 3;
    ...
    @Parameter(names = {"--execute-time-minutes"}, description = "Specifies the time to generate and execute transactions for a database")
    private double exeTimeMinutes = 10;

    public int getMaxProductionRecursion() {
        return maxProductionRecursion;
    }

    public void setMaxProductionRecursion(int maxProductionRecursion) {
        this.maxProductionRecursion = maxProductionRecursion;
    }
