...
public final class Randomly {
    ...
    public static <T> T fromWeights(Map<T, Integer> weights) {
    ...
    public static int getNotCachedInteger(int lower, int upper) {
        return (int) getNextLong(lower, upper);
    }

    public static long getNotCachedLong(long lower, long upper) {
    ...
    // randgen.sqlancer previously used ThreadLocalRandom.current().nextLong(lower,
    // upper)
     ...
     */
    public static double getNonCachedDouble(double lower, double upper) {
        BigDecimal bLower = new BigDecimal(lower);
        BigDecimal bUpper = new BigDecimal(upper);
        BigDecimal randBigDecimal = new BigDecimal(getUncachedDouble());
        Double randDouble = (bUpper.subtract(bLower)).multiply(randBigDecimal).doubleValue();
        return lower + randDouble;
    }
